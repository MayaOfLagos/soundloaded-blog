      ...
      <div className="flex flex-wrap gap-1">
        {["ALL", "CONFIRMED", "PENDING", "UNSUBSCRIBED"].map((s) => (
          <button
            ...
            className={`rounded-lg px-3 py-1.5 text-sm font-medium transition-colors ${statusFilter === s ? "bg-brand text-brand-foreground" : "bg-muted text-muted-foreground hover:bg-muted/80"}`}
          >
