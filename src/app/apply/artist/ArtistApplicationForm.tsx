...
import { Loader2, Plus, X, Music, CheckCircle2 } from "lucide-react";
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="bg-card/50 ring-border/40 space-y-5 rounded-2xl p-6 ring-1 backdrop-blur-sm">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="displayName">Artist / Stage Name *</Label>
          <Input
            id="displayName"
        ...
        <div className="space-y-1.5">
          ...
          <div className="text-muted-foreground flex items-center gap-1 text-xs">
            <span>soundloaded.ng/artists/</span>
            <Input id="slug" placeholder="wizkid" className="flex-1" {...register("slug")} />
          </div>
      ...
      <div className="bg-card/50 ring-border/40 space-y-4 rounded-2xl p-6 ring-1 backdrop-blur-sm">
        <h2 className="text-foreground font-semibold">Social Links</h2>
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="space-y-1.5">
            <Label>Spotify</Label>
            <Input placeholder="Artist URL" {...register("socialLinks.spotify")} />
          </div>
          <div className="space-y-1.5">
            <Label>Apple Music</Label>
            <Input placeholder="Artist URL" {...register("socialLinks.appleMusic")} />
          </div>
        </div>
      </div>
      ...
      <div className="bg-card/50 ring-border/40 space-y-4 rounded-2xl p-6 ring-1 backdrop-blur-sm">
        <div>
          ...
          <p className="text-muted-foreground mt-0.5 text-xs">
            Add links that verify you are this artist (Spotify profile, social media, press, etc.)
          </p>
        </div>
