...
import { LabelApplicationForm } from "./LabelApplicationForm";
import { Clock, XCircle } from "lucide-react";

export const metadata: Metadata = {
  title: "Apply as Record Label — Soundloaded",
  description: "Apply to manage your label and artists on Soundloaded.",
};

export default async function ApplyLabelPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
      <div className="mb-8 text-center">
        <h1 className="text-foreground text-2xl font-bold">Apply as Record Label</h1>
        <p className="text-muted-foreground mt-2 text-sm">
          Submit your application to manage your label, artists, and releases on Soundloaded.
        </p>
      </div>
