  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          "bg-secondary outline-background flex cursor-pointer items-center gap-1.5 overflow-hidden p-3 font-mono uppercase shadow-md outline outline-2 transition-colors duration-75 ease-out",
        ...
        {isActive && (
          ...
          >
            <motion.span
              ...
              className="relative inline-block font-mono text-sm font-medium whitespace-nowrap uppercase"
              style={{ willChange: "transform" }}
            >
              {title}
            </motion.span>
