              ...
              {items.map((chip, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-card border-border pointer-events-auto absolute z-10 flex w-[240px] origin-bottom items-center gap-2 rounded-full border p-2 shadow-sm"
                  >
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <span className="text-muted-foreground text-xs">{chip.description}</span>
                    </div>
                  </motion.div>
                );
              })}
