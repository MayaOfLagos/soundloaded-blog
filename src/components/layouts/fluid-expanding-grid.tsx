...
export default function FluidExpandingGrid({
  ...
  return (
    <div
      className={cn(
        "not-prose flex h-full w-full items-center justify-center overflow-hidden py-12",
        className
      )}
    >
            ...
            {items.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <img
                      ...
                      className={cn(
                        ...
                        isSelected ? "object-[center_35%]" : "object-[center_50%]"
                      )}
                    />
                    <motion.div
                  ...
                  <motion.div
                    layout="position"
                    className="absolute inset-0 z-10 flex flex-col justify-end p-6 text-white select-none"
                  >
                    <motion.div layout="position" className="overflow-hidden">
                      <motion.h3
                        layout="position"
                        className="mb-1 text-2xl font-medium tracking-tight sm:text-3xl"
                      >
                        {item.title}
                      </motion.h3>
                      <motion.p
                        layout="position"
                        className="text-xs font-normal whitespace-nowrap text-white/80 sm:text-sm"
                      >
                        {item.subtitle}
                      </motion.p>
                    </motion.div>
