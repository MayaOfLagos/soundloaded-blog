...
function FolderInteraction() {
  ...
  return (
    <div className="flex w-full items-center justify-center">
      <div onClick={() => setIsOpen(!isOpen)} className="wrapper relative h-52 w-80">
        <div
        ...
        <motion.div
          ...
          className="absolute -right-[1px] -bottom-[1px] -left-[1px] z-20 flex h-44 origin-bottom items-center justify-center overflow-visible rounded-3xl"
        >
          <svg
